    ...
    <div class="cajaPrincipal">
        <?php
            ...
            if (!$conexion) {
                ...
                $consultarTodo = "SELECT usuarios.id AS 'id', usuarios.username AS 'username', usuarios.nombre AS 'nombre', usuarios.apellidos AS 'apellidos', usuarios.email AS 'email', usuarios.telefono AS 'telefono', usuarios.password AS 'password', usuarios.rol AS 'rol' FROM usuarios;";
