...
<body>
    ...
    <div class="cajaPrincipal">
        ...
        $bd = ""; //Auí iría el Nombre de la Base de Datos.
        ...
        if (!$enlace) {
            ...
            session_start();
            $consultarTodo = "SELECT * FROM incidencia;";
            $eliminarIncidencia = "DELETE FROM incidencia WHERE id = $i";
            $resultado = mysqli_query($enlace, $consultarTodo);
